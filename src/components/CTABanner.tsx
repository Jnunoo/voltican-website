      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center h-13 px-8 rounded-full border-2 border-white/30 text-white font-semibold text-base hover:bg-white/10 transition-colors"
          >
            Call (713) 714-4965
          </a>
        </div>
